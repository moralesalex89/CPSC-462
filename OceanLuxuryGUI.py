...
class OceanLuxuryGUI:
    def __init__(self, master):
        ...
        self.img_10 = PhotoImage(file='OL-Assets/booking.png')
        self.img_11 = PhotoImage(file='OL-Assets/services.png')
        ...
        self.signup = ttk.Button(self.sidebar_frame, image=self.img_06, command=self.signupUser)
        self.logout = ttk.Button(self.sidebar_frame, image=self.img_07, command=self.logoutUser)
        self.account = ttk.Button(self.sidebar_frame, image=self.img_08)
    ...
    def set_sidebar_frame(self, layout):
        ...
        if layout == 1:
            ...
            self.booking.config(command=self.UI_Controller.booking_press, image=self.img_03)
            self.services.config(command=self.UI_Controller.services_press, image=self.img_11)
        ...
        if layout == 2:
            self.home.config(command=self.UI_Controller.home_press)
            self.about.grid_forget()
            self.booking.config(command=self.UI_Controller.booking_press, image=self.img_10)
            self.services.config(command=self.UI_Controller.services_press, image=self.img_04)
            self.account.config(command=self.UI_Controller.account_press)
            self.booking.grid()
            self.services.grid()
            self.account.grid()
    ...
    def login_press(self):
        ...
        logBtn = ttk.Button(self.center_frame, text="Login",
                            command=lambda: self.loginUser(username.get(), password.get()))
    ...
    def signupUser(self):
        ...
        ttk.Button(self.center_frame, text="Sign-Up",
                   command=lambda: self.signupValidate(username.get(), password.get(), pass_check.get())).grid(
            columnspan=2)
